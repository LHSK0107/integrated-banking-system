...
const Index = () => {
    ...
    const totolCal = (() => {
        let total = Number(stateBalCal())+Number(depAInsBalCal())+Number(loanBalCal());
        console.log(total);
        return total+"";
    })
    ...
    useEffect(() => {
        ...
        axios.get(url).then((res) => {
            res.data.RESP_DATA.REC===null ? console.log("입출 failed") : console.log("입출 success");
    ...
    <div id="wrap">
        <div className="banner">
            <div className="inner flex">
                <div className="member">
                    <p>ADMIN</p>
                    <h2>안녕하세요,<br /><span>홍길동</span>님</h2>
                    <div className="flex justify_between">
                        <a className="flex btn" href="../AllAccount/index.html">조회</a>
                        <a className="flex btn" href="../InOutReport/index.html">보고서</a>
                    </div>
                </div>
                <div className="total">
                    <div className="total_total">
                        <div className="flex justify_between"><p>보유 총 자산</p><span>조회일시 {new Date(new Date().getTime() + (9 * 60 * 60 * 1000)).toISOString().replace('T', ' ').slice(0, -5)}</span></div>
                        <h3><Balance balance={totolCal()}/></h3>
                    </div>
                    <div className="section_total flex">
                        <div className="check">
                            ...
                            <div>
                                <p><span>총액</span><Balance balance={stateBalCal()}/></p>
                            </div>
                        </div>
                        <div className="deposit">
                            ...
                            <div>
                                <p><span>총액</span><Balance balance={depAInsBalCal()}/></p>
                            </div>
                        </div>
                        <div className="loan">
                            <div className="flex">
                            ...
                            <div>
                                ...
                                <p><span>총액</span><Balance balance={loanBalCal()}/></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div>
            <div className="chart_wrap inner">
                ...
                <div className="column"><Bar data={inoutProps} /></div>
            </div>
        </div>
    </div>
    );
